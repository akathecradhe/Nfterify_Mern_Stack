...
function CreateItem() {
    ...
    useEffect(() => { setImage(getRandomImg()) }, [])
    ...
    const postData =  () => {
        ...
        axios.post(baseurl+'/admin/createItem',{
            name: name,description: description,brandName:brandName,
            collectionName:collectionName,
            image:image,userDetailsID:user.userInfoID,sizes:sizes,
        });
                ...
                <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10 drop-shadow-2xl">
                    <div className="mb-0 space-y-6"  >
                            ...
                            <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600">
                                        <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-300 hover:text-blue-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-300">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="itemname" name="itemname"
                                       type="name" autoComplete="itemname" required className="shadow appearance-none border rounded w-full py-2 px-3
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <select id="Collection" name="Collection"  required className=" shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                          leading-tight bg-white rounded-md shadow-sm
                        focus:outline-none focus:ring-blue-300 focus:border-blue-300 sm:text-sm" onChange={(e) => setCollectionName(e.target.value)} >
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <textarea id="description" name="description" type="description"
                                          autoComplete="description" required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                        ...
                        <label htmlFor="heading" className="block text-sm font-medium text-gray-700">Sizes Available</label>
                        <div className="inline-grid grid-cols-6 gap-6" >

                            <span>
                                <label htmlFor="sizeXL" className="block text-sm font-medium text-gray-700">XL</label>
                                <div className="mt-1">
                                    <input id="sizeXL" name="xLarge" type="number" placeholder="0" min="0" required className="shadow appearance-none border rounded w-10 h-10
                            ...
                            <span>
                                <label htmlFor="sizeL" className="block text-sm font-medium text-gray-700">L</label>
                                <div className="mt-1">
                                    <input id="sizeL" name="large" type="number" placeholder="0"  min="0" required className="shadow appearance-none border rounded w-10 h-10
                                    py-2 px-3 text-gray-700 leading-tight focus:outline-none w-14 h-14
                                    focus:shadow-outlinefocus:outline-none focus:ring-blue-300 focus:border-blue-300
                            ...
                            <span >
                                <label htmlFor="sizeM" className="block text-sm font-medium text-gray-700 ">M</label>
                                <div className="mt-1">
                                    <input id="sizeM" name="medium" type="number" placeholder="0" min="0"  required className="shadow appearance-none border rounded w-10 h-10
                                    py-2 px-3 text-gray-700 leading-tight focus:outline-none w-14 h-14
                                    focus:shadow-outlinefocus:outline-none focus:ring-blue-300 focus:border-blue-300
                            ...
                            <span>
                                <label htmlFor="sizeS" className="block text-sm font-medium text-gray-700">S</label>
                                <div className="mt-1">
                                    <input id="sizeS" name="small" type="number" placeholder="0"  min="0"
                                           required className="shadow appearance-none border rounded w-14 h-14
                            ...
                            <span>
                                <label htmlFor="xSmall" className="block text-sm font-medium text-gray-700">XS</label>
                                <div className="mt-1">
                                    <input id="sizeXS" name="xSmall" type="number" placeholder="0" min="0"  className="shadow appearance-none border rounded w-14 h-14
                                    py-2 px-3 text-gray-700 leading-tight focus:outline-none
                                    focus:shadow-outlinefocus:outline-none focus:ring-blue-300 focus:border-blue-300
