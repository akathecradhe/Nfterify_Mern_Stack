                    ...
                    <div className="px-6">
                        ...
                        <div className="flex justify-center gap-x-40 ">
                            <div className="mb-2 text-gray-700 flex items-center justify-center gap-2">
                                ...
                                border-transparent hover:text-blue-700 hover:border-blue-700 " aria-current="page">Create</button>
                            </div>
                            <div className="mb-3 text-gray-700 text-center  gap-6">
                                <span>
                                    <button className="font-medium text-center text-gray-500 rounded-t-lg border-b-2
                                border-transparent hover:text-blue-700 hover:border-blue-700 ">Wallet</button>
                                </span>
                            </div>
                        </div>
